<div class="row-fluid form-tratamento" id="avista">
	...
	<div class="row-fluid">
		...
		<div class="col-md-2">
			<?php echo form_label( '<div class="nome-valor">Valor da Sessão</div>', 'valor' ); ?>
...
<div class="row-fluid" id="faturamento">
	...
	<div class="col-md-4">
		...
		<?php echo form_dropdown('tipo_pagamento', $tipos_pagamento, set_value('tipo_pagamento', isset($tratamento->tipo_pagamento_id) ? $tratamento->tipo_pagamento_id : ''), 'class="form-control" id="tipo_pagamento"' ); ?>
	</div>
	<div class="col-md-8">
