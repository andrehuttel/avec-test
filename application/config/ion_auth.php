...
|
*/
$config['collections']['users']          = 'usuario';
...
$config['tables']['sys_metodos']	 = 'sys_metodo';
/* ---------------------------------- */
...
$config['join']['groups'] = 'nivel_permissao_id';
 ...
 */
$config['site_title']           = "Avec"; 		// Site Title, example.com
